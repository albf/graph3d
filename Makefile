...
# Generated by qmake (2.01a) (Qt 4.8.4) on: sam. mai 3 02:41:39 2014
# Project:  cg3D.pro
# Template: app
...
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  -L/usr/X11R6/lib -L/usr/lib/i386-linux-gnu -lglut -lQGLViewer -lGL -lQtXml -lQtOpenGL -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/cg3D1.0.0/ && $(COPY_FILE) --parents cylinder.h fishA.h lightsMaterials.h renderable.h viewer.h .tmp/cg3D1.0.0/ && $(COPY_FILE) --parents cylinder.cpp fishA.cpp lightsMaterials.cpp main.cpp viewer.cpp .tmp/cg3D1.0.0/ && (cd `dirname .tmp/cg3D1.0.0` && $(TAR) cg3D1.0.0.tar cg3D1.0.0 && $(COMPRESS) cg3D1.0.0.tar) && $(MOVE) `dirname .tmp/cg3D1.0.0`/cg3D1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/cg3D1.0.0
