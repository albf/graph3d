...
# Generated by qmake (2.01a) (Qt 4.8.4) on: sam. mai 3 06:24:23 2014
# Project:  cg3D.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/cg3D1.0.0/ && $(COPY_FILE) --parents cam.h fishA.h lightsMaterials.h renderable.h viewer.h .tmp/cg3D1.0.0/ && $(COPY_FILE) --parents cam.cpp fishA.cpp lightsMaterials.cpp main.cpp viewer.cpp .tmp/cg3D1.0.0/ && (cd `dirname .tmp/cg3D1.0.0` && $(TAR) cg3D1.0.0.tar cg3D1.0.0 && $(COMPRESS) cg3D1.0.0.tar) && $(MOVE) `dirname .tmp/cg3D1.0.0`/cg3D1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/cg3D1.0.0
