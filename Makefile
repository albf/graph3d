...
# Generated by qmake (2.01a) (Qt 4.8.4) on: mer. mai 7 00:09:40 2014
# Project:  cg3D.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/cg3D1.0.0/ && $(COPY_FILE) --parents bubble.h cam.h crab.h diver.h fishA.h fishB.h light.h lightsMaterials.h pacMan.h renderable.h seaFloor.h viewer.h .tmp/cg3D1.0.0/ && $(COPY_FILE) --parents bubble.cpp cam.cpp crab.cpp diver.cpp fishA.cpp fishB.cpp light.cpp lightsMaterials.cpp main.cpp pacMan.cpp renderable.cpp seaFloor.cpp viewer.cpp .tmp/cg3D1.0.0/ && (cd `dirname .tmp/cg3D1.0.0` && $(TAR) cg3D1.0.0.tar cg3D1.0.0 && $(COMPRESS) cg3D1.0.0.tar) && $(MOVE) `dirname .tmp/cg3D1.0.0`/cg3D1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/cg3D1.0.0
...
renderable.o: renderable.cpp renderable.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o renderable.o renderable.cpp
