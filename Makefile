...
# Generated by qmake (2.01a) (Qt 4.8.4) on: dim. mai 4 23:43:59 2014
# Project:  cg3D.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/cg3D1.0.0/ && $(COPY_FILE) --parents cam.h fishA.h fishB.h lightsMaterials.h renderable.h viewer.h .tmp/cg3D1.0.0/ && $(COPY_FILE) --parents cam.cpp fishA.cpp fishB.cpp lightsMaterials.cpp main.cpp viewer.cpp .tmp/cg3D1.0.0/ && (cd `dirname .tmp/cg3D1.0.0` && $(TAR) cg3D1.0.0.tar cg3D1.0.0 && $(COMPRESS) cg3D1.0.0.tar) && $(MOVE) `dirname .tmp/cg3D1.0.0`/cg3D1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/cg3D1.0.0
...
fishA.o: fishA.cpp fishB.h \
		renderable.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o fishA.o fishA.cpp

fishB.o: fishB.cpp fishA.h \
		renderable.h
