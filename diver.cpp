...
// Initialize the diver, everything scaled by his size
...
// Manage the time variable, so the cycle of animation repeats itself successfully
...
// Draw the scene, the movement is treated here, using the time generated by the 
// animate function.
void Diver::draw() {
